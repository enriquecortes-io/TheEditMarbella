...
export default function GallerySection({ galleryTrackRef, images, titulo, ubicacion, onImageClick, locale = "es" }: GallerySectionProps) {
  ...
  return (
    <>
      ...
      <div style={{ position:"absolute", top:"300vh", left:0, width:"100%", height:"50vh", className:"gallery-section", overflow:"hidden", background:"linear-gradient(to bottom, #050505, #0a0a0a)", borderTop:"1px solid rgba(201,169,110,0.15)" }}>
