...
const CONTENT: Record<string, any> = {
  ...
  fr: {
    ...
    s3: { tag:'03 — La Sélection', h:["Seul l'extra-",'ordinaire','entre.'], body:"The Edit n'est pas un catalogue. C'est une curation.", carta:"Chaque propriété de The Edit a fait l'objet d'un processus de révision personnel. Nous travaillons avec discernement. Avant de vous présenter une résidence, je l'ai visitée, analysée et comprise. Son architecture, son environnement, son potentiel. Mon engagement est de vous donner un accès exclusif à ce qui mérite votre attention, avec un service entièrement personnalisé." },
  },
  ru: {
